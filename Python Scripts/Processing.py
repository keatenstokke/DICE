...
pwd = 'C:\Users\knstokke\Documents\Python_Tests'
...
TCP_IP = '192.168.1.10'
TCP_PORT = 7
BUFFER_SIZE = 1460 # 146 numbers stored per packet (1460 bytes per packet w/o header information)
...
s.sendall('1234567890')

while amount_received2 < 22:
